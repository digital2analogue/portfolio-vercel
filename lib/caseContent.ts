  ...
  "system": {
    ...
    blocks: [
      ...
      { type: "hr" },
      {
        type: "stats",
        items: [
          { value: "31", label: "Framework-agnostic components" },
      ...
      },
      {
        ...
        items: [
          ...
          "**Components.** 31 framework-agnostic Lit web components. Code Connect mappings are authored for 22 and held to each component's real prop unions by a build gate — unpublished, because Code Connect needs a Figma Enterprise plan.",
